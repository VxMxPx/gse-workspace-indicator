...
const WorkspaceIndicator = new Lang.Class({
    ...
    this.statusContainer = new St.Bin({ style_class : 'panel-workspace-indicator' });
	this.statusLabel = new St.Label({ text: this._labelText() });

    this.statusContainer.set_child(this.statusLabel);
	this.actor.add_actor(this.statusContainer);
	...
	//styling
	this.statusLabel.add_style_class_name('panel-workspace-indicator-label');
